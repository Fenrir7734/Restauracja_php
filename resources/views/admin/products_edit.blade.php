                            ...
                            <form  role="booking-form" method="POST" action="{{ route('update-products', $product->id) }}" enctype="multipart/form-data" style="margin-top: 10px">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control @error('postcode') is-invalid @enderror" value="{{ $product->name }}">
                                        @if($errors->has('name'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" id="price" name="price" class="form-control @error('postcode') is-invalid @enderror" pattern="[0-9]+([\.,][0-9]+)?" step="0.01" value="{{ $product->price }}">
                                        @if($errors->has('price'))
