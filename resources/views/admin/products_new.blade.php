                            ...
                            <form  role="booking-form" method="POST" action="{{ route('store-products') }}" enctype="multipart/form-data" style="margin-top: 10px">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control @error('postcode') is-invalid @enderror" value="{{ old('name') }}">
                                        @if($errors->has('name'))
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="file" id="image" name="image" class="form-control @error('postcode') is-invalid @enderror" value="{{ old('image') }}">
                                        @if($errors->has('image'))
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select type="text" id="category" name="category" class="form-control @error('postcode') is-invalid @enderror">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" id="price" name="price" class="form-control @error('postcode') is-invalid @enderror" pattern="[0-9]+([\.,][0-9]+)?" step="0.01" value="{{ old('price') }}">
                                        @if($errors->has('price'))
